...
class En2pg8 extends StatefulWidget {
  const En2pg8({super.key});

  @override
  State<En2pg8> createState() => _five_activityState();
}

class _five_activityState extends State<En2pg8> {
                ...
                Column(
                  children: [
                    Container(
                      height: 200,
                      width: 200,
                      child: Image(image: AssetImage('assets/activity_img/read.png'),),),
