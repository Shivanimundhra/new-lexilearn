...
class En2pg1 extends StatefulWidget {
  const En2pg1({super.key});

  @override
  State<En2pg1> createState() => _SixPageState();
}

double _initial = 0.0;

class _SixPageState extends State<En2pg1> {
  ...
  speak_Apple() async {
    ...
    await flutterTts.speak("good night");
  }
