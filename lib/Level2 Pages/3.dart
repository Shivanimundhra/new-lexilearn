...
class En2p3 extends StatefulWidget {
  const En2p3({super.key});

  @override
  State<En2p3> createState() => _T_activeState();
}

double _initial = 0.4;

class _T_activeState extends State<En2p3> {
  ...
  speak(String text) async {
    await flutterTts.setLanguage("en-US");
    await flutterTts.setPitch(1);
    await flutterTts.speak("I $text a boy ? ");
  }
