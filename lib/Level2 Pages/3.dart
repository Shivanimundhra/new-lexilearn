...
class En2pg2 extends StatefulWidget {
  const En2pg2({super.key});

  @override
  State<En2pg2> createState() => _SixPageState();
}

double _initial = 0.0;

class _SixPageState extends State<En2pg2> {
  ...
  speak_Apple() async {
    ...
    await flutterTts.speak("See You");
  }
