...
class En2pg7 extends StatefulWidget {
  const En2pg7({super.key});

  @override
  State<En2pg7> createState() => _SecondPageState1();
}

double _initial = 0.0;

class _SecondPageState1 extends State<En2pg7> {
  ...
  speak() async {
    ...
    await flutterTts.speak("Standing");
  }
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Image(
                                    image: AssetImage("assets/activity_img/sleep.png"),
                                  ),
                                ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Image(
                                    image: AssetImage("assets/activity_img/play.png"),
                                  ),
                                ),
                                SizedBox(height: 10), // Added SizedBox for spacing
                                Text(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Image(
                                        image: AssetImage("assets/activity_img/stand.png"),
                                      ),
                                    ),
                                    SizedBox(height: 10), // Added SizedBox for spacing
                                    Text(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Image(
                                        image: AssetImage("assets/activity_img/read.png"),
                                      ),
                                    ),
                                    SizedBox(height: 10), // Added SizedBox for spacing
                                    Text(
