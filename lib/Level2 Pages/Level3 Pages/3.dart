...
class En3p3 extends StatefulWidget {
  const En3p3({super.key});

  @override
  State<En3p3> createState() => _T_activeState();
}

double _initial = 0.4;

class _T_activeState extends State<En3p3> {
  ...
  Are() async {
    await flutterTts.setLanguage("en-US");
    await flutterTts.setPitch(1);
    await flutterTts.speak("is an");
  }

  have() async {
    await flutterTts.setLanguage("en-US");
    await flutterTts.setPitch(1);
    await flutterTts.speak("is the");
  }
  ...
  speak(String text) async {
    await flutterTts.setLanguage("en-US");
    await flutterTts.setPitch(1);
    await flutterTts.speak("This $text book? ");
  }
