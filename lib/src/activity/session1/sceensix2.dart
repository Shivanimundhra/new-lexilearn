...
class Six2Page extends StatefulWidget {
  const Six2Page({super.key});

  @override
  State<Six2Page> createState() => _SixPageState();
}

double _initial = 0.0;

class _SixPageState extends State<Six2Page> {
