...
class Sp_four extends StatefulWidget {
  const Sp_four({super.key});

  @override
  State<Sp_four> createState() => _Sp_four();
}

class _Sp_four extends State<Sp_four> {
  ...
  speak() async {
    ...
    await flutterTts.speak("Hoy es un buen día ");
  }

  speak_one() async {
    await flutterTts.setLanguage("en-es");
    await flutterTts.setPitch(1);
    await flutterTts.speak("Hoy");
  }
  ...
  speak_three() async {
    await flutterTts.setLanguage("en-es");
    await flutterTts.setPitch(1);
    await flutterTts.speak("buen");
  }
  speak_four() async {
    await flutterTts.setLanguage("en-es");
    await flutterTts.setPitch(1);
    await flutterTts.speak("día");
  }
