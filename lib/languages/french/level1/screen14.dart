...
class Six5Page extends StatefulWidget {
  const Six5Page({super.key});

  @override
  State<Six5Page> createState() => _SixPageState();
}

double _initial = 0.0;

class _SixPageState extends State<Six5Page> {
