...
class En4p2 extends StatefulWidget {
  const En4p2({super.key});

  @override
  State<En4p2> createState() => _T_activeState();
}

double _initial = 0.4;

class _T_activeState extends State<En4p2> {
  ...
  speak_two() async {
    await flutterTts.setLanguage("en-US");
    await flutterTts.setPitch(1);
    await flutterTts.speak("is your ");
  }
  ...
  speak(String text) async {
    await flutterTts.setLanguage("en-US");
    await flutterTts.setPitch(1);
    await flutterTts.speak("$text is your name ");
  }
