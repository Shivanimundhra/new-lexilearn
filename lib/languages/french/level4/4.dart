...
class En4p4 extends StatefulWidget {
  const En4p4({super.key});

  @override
  State<En4p4> createState() => _SixPageState();
}

double _initial = 0.0;

class _SixPageState extends State<En4p4> {
  ...
  speak_Apple() async {
    ...
    await flutterTts.speak("वह खड़ी है");
  }
