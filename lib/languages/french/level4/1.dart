...
class En4p1 extends StatefulWidget {
  const En4p1({super.key});

  @override
  State<En4p1> createState() => _SixPageState();
}

double _initial = 0.0;

class _SixPageState extends State<En4p1> {
  ...
  speak_Apple() async {
    ...
    await flutterTts.speak("May I drive your car");
  }
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(
                              child: Text(
                                "क्या मैं आपकी साइकिल चला सकता हूँ?",
                                style: TextStyle(
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(
                              child: Text(
                                "क्या मैं आपकी कार चला सकता हूँ?",
                                style: TextStyle(
                                    fontSize: 20.0, fontWeight: FontWeight.bold),
                              )),
                        ),
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: Text(
                                    "क्या मैं आपका ऑटो चला सकता हूँ?",
                                    style: TextStyle(
                                        fontSize: 20.0, fontWeight: FontWeight.bold),
                                  )),
                            ),
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: Text(
                                    "क्या मैं आपकी बाइक चला सकता हूँ?",
                                    style: TextStyle(
                                        fontSize: 20.0, fontWeight: FontWeight.bold),
                                  )),
                            ),
