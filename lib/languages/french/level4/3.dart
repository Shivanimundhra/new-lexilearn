...
class En4p3 extends StatefulWidget {
  const En4p3({super.key});

  @override
  State<En4p3> createState() => _SixPageState();
}

double _initial = 0.0;

class _SixPageState extends State<En4p3> {
  ...
  speak_Apple() async {
    ...
    await flutterTts.speak("चाय गर्म है");
  }
