...
class En5pg2 extends StatefulWidget {
  const En5pg2({super.key});

  @override
  State<En5pg2> createState() => _four_activityState();
}

class _four_activityState extends State<En5pg2> {
  ...
  speak() async {
    ...
    await flutterTts.speak("Have a tea");
  }
